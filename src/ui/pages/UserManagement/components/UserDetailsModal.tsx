...
import { X, UserRound, Trash2, Edit } from "lucide-react";
import type { UserMember } from "../../../../types/user.types";

interface UserDetailsModalProps {
  selectedUser: UserMember;
  closeModal: () => void;
        ...
        <div className="bg-white p-6 rounded-t-xl border-b border-gray-200 flex items-center space-x-6 relative">
          <div className="p-4 bg-blue-100 rounded-full">
            {selectedUser.profilePic ? (
                <img src={selectedUser.profilePic} alt="Profile" className="w-12 h-12 rounded-full object-cover" />
            ) : (
