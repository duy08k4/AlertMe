                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <a href="https://github.com/duy08k4/AlertMe.git" target="_blank" rel="noopener noreferrer" className="text-red-100 hover:text-white underline transition">github.com/duy08k4/AlertMe</a>
                                </div>
                            </div>
                        </div>
                    </motion.div>
